...
template ECDSAVerifyNoPubkeyCheck(n, k) {
    ...
    var p[100] = get_p384_prime(n, k);
    var order[100] = get_p384_order(n, k);
    ...
    component pubkey_mult = P384ScalarMult(n, k);
    for (var idx = 0; idx < k; idx++) {
    ...
    component sum_res = P384AddUnequal(n, k);
    for (var idx = 0; idx < k; idx++) {
